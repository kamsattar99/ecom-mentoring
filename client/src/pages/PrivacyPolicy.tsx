export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fbfaf8] to-[#f6f4f8]">
      <div className="container max-w-[800px] py-20 md:py-28">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-[15px] leading-[1.8] text-gray-700">
          <p>
            E-commerce Mentoring understands that your privacy is important to you. We are committed to protecting the privacy of your personally-identifiable information as you use this website. This Privacy Policy tells you how we protect and use information that we gather from you. By using this website, you consent to the terms described in the most recent version of this Privacy Policy. You should also read our Terms of Use to understand the general rules about your use of this website, and any additional terms that may apply when you access particular services or materials on certain areas of this website. "We," "our" means E-commerce Mentoring and its affiliates. "You," "your," "visitor," or "user" means the individual accessing this site.
          </p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Personal and Non-Personal Information</h2>
          <p>Our Privacy Policy identifies how we treat your personal and non-personal information.</p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">What Is Non-Personal Information and How Is It Collected and Used?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">What Is Personal Information and How Is It Collected?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Are Cookies or Other Technologies Used to Collect Personal Information?</h2>
          <p>
          ...
          <p>
            For example, if you register with us, a cookie helps E-commerce Mentoring to recall your specific information on subsequent visits. This simplifies the process of recording your personal information, such as billing addresses, shipping addresses, and so on. When you return to the same E-commerce Mentoring website, the information you previously provided can be retrieved, so you can easily use the features that you customized.
          </p>
          <p>
          ...
          <p>
            You have the ability to accept or decline cookies. Most Web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. If you choose to decline cookies, you may not be able to fully experience the interactive features of the E-commerce Mentoring websites you visit.
          </p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">How Does E-commerce Mentoring Use Personal Information?</h2>
          <p>
            E-commerce Mentoring may keep and use personal information we collect from or about you to provide you with access to this web site or other products or services, to respond to your requests, to bill you for products/services you purchased, and to provide ongoing service and support, to contact you with information that might be of interest to you, including information about products and services of ours and of others, or ask for your opinion about our products or the products of others, for record keeping and analytical purposes and to research, develop and improve programs, products, services and content.
          </p>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Does E-commerce Mentoring Share Personal Information with Others?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">How Is Personal Information Used for Communications?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">How Is Personal Information Secured?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Links</h2>
          <p>
            This site contains links to other sites that provide information that we consider to be interesting. E-commerce Mentoring is not responsible for the privacy practices or the content of such web sites.
          </p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Public Discussions</h2>
          <p>
            This site may provide public discussions on various business valuation topics. Please note that any information you post in these discussions will become public, so please do not post sensitive information in the public discussions. Whenever you publicly disclose information online, that information could be collected and used by others. We are not responsible for any action or policies of any third parties who collect information that users disclose in any such forums on the web site. E-commerce Mentoring does not agree or disagree with anything posted on the discussion board. Also remember that you must comply with our other published policies regarding postings on our public forums.
          </p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">How Can a User Access, Change, and/or Delete Personal Information?</h2>
          <p>
            You may access, correct, update, and/or delete any personally-identifiable information that you submit to the web site. You may also unsubscribe from mailing lists or any registrations on the web site. To do so, please either follow instructions on the page of the web site on which you have provided such information or subscribed or registered or contact us.
          </p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Children's Privacy</h2>
          <p>
            E-commerce Mentoring will not intentionally collect any personal information (such as a child's name or email address) from children under the age of 13. If you think that we have collected personal information from a child under the age of 13, please contact us.
          </p>

          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Changes</h2>
          <p>
            E-commerce Mentoring reserves the right to modify this statement at any time. Any changes to this Privacy Policy will be listed in this section, and if such changes are material, a notice will be included on the homepage of the web site for a period of time. If you have any questions about privacy at any websites operated by E-commerce Mentoring or about our website practices, please contact us.
          </p>
        </div>
      </div>
    </div>
