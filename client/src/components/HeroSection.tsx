    ...
    <section className="relative pt-[130px] pb-[60px] md:pt-[160px] md:pb-[80px] overflow-hidden">
      ...
      <div className="container relative">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-0 mb-10"
        >
          {/* Stat 1 */}
          <div className="flex items-center gap-2.5 sm:px-6">
            <div className="w-9 h-9 rounded-full bg-[#EDE8F5] flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <p className="text-[16px] font-bold text-[#17191c] leading-tight">1,000+</p>
              <p className="text-[12px] text-[#777b86]">Entrepreneurs trained</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 sm:px-6">
            ...
            <div>
              <p className="text-[16px] font-bold text-[#17191c] leading-tight">4.9/5</p>
              <p className="text-[12px] text-[#777b86]">Student rating</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 sm:px-6">
            ...
            <div>
              <p className="text-[16px] font-bold text-[#17191c] leading-tight">7+ Years</p>
              <p className="text-[12px] text-[#777b86]">E-commerce experience</p>
            </div>
          </div>
        </motion.div>
